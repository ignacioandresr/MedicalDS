            ...
            <div class="col-12">
                ...
                <form action="{{ route('diagnostics.update', $diagnostic) }}" method="POST">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <input type="text" class="form-control mb-2" id="searchPatient" name="patient_rut" placeholder="Buscar por RUT o nombre..." autocomplete="off" required value="{{ $diagnostic->patient->rut }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="description" name="description" value="{{ $diagnostic->description }}">
                    </div>
                    <div class="mb-3">
